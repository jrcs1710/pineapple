...
public class MovimentacaoDao implements Dao {
	...
	public List<Movimentacao> buscarMovimentacao_Data(Calendar data) {
		TypedQuery<Movimentacao> lista = manager.createQuery(
				"SELECT m FROM Movimentacao m where m.dtSolicitacao = :data",
	...
	public List<Movimentacao> buscarMovimentacao_Solicitante(Funcionario solicitante) {
		TypedQuery<Movimentacao> lista = manager.createQuery(
				"SELECT m FROM Movimentacao m where m.solicitante = :solicitante",
				Movimentacao.class).setParameter("solicitante", solicitante);
	...
	public List<Movimentacao> buscarMovimentacaoStatus_Solicitante(Funcionario solicitante, StatusRequisicao status) {
		TypedQuery<Movimentacao> lista = manager.createQuery(
				"SELECT m FROM Movimentacao m where m.solicitante = :solicitante AND m.status = :status ORDER BY m.dtSolicitacao DESC",
				Movimentacao.class).setParameter("solicitante", solicitante).setParameter("status", status);
	...
	public List<Movimentacao> buscarMovimentacao_Status(StatusRequisicao status) {
		TypedQuery<Movimentacao> lista = manager.createQuery(
	...
	public List<Movimentacao> buscarMovimentacao_StatusNegativo(StatusRequisicao status) {
		TypedQuery<Movimentacao> lista = manager.createQuery(
				"SELECT m FROM Movimentacao m where m.status != :status ",
				Movimentacao.class).setParameter("status", status);
	...
	public List<Movimentacao> buscarMovimentacao_StatusAmbiente(StatusRequisicao status, Ambiente ambienteA, Ambiente ambienteD) {
		TypedQuery<Movimentacao> lista = manager.createQuery(
				"SELECT m FROM Movimentacao m where m.status != :status AND m.atual = :atual OR m.destino = :destino",
				Movimentacao.class).setParameter("status", status).setParameter("atual", ambienteA).setParameter("destino", ambienteD);
